...
public class StochasticExpressionEditDialogOLD extends AbstractGrammerBasedEditDialog {
     ...
     *            the expected type
     */
    public StochasticExpressionEditDialogOLD(final Shell parent, final TypeEnum expectedType) {
        super(parent);
     ...
     *            the context
     */
    public StochasticExpressionEditDialogOLD(final Shell parent, final TypeEnum expectedType, final Parameter[] context) {
