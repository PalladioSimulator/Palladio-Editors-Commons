...
public class AbstractUserActionItemProviderTest {
    ...
    @Test
    public void addSuccessorAbstractUserActionPropertyDescriptorTest() {
        ScenarioBehaviour scenario = TestItemProviderUtilities.getScenarioBehaviour("__hrGYHD6EeSA4fySuX9I2Q",
                testUsageModel);
        AbstractUserAction testAction = TestItemProviderUtilities.getAbstractUserAction("_TutY0Hk9EeSGtbTG2d9Ipg",
                scenario);

        // define expected result
        AbstractUserAction stopAction = TestItemProviderUtilities.getAbstractUserAction("__huJsHD6EeSA4fySuX9I2Q",
                scenario);
    ...
    @Test
    public void addPredecessorAbstractUserActionPropertyDescriptorTest() {
        ScenarioBehaviour scenario = TestItemProviderUtilities.getScenarioBehaviour("__hrGYHD6EeSA4fySuX9I2Q",
                testUsageModel);
        AbstractUserAction testAction = TestItemProviderUtilities.getAbstractUserAction("_TutY0Hk9EeSGtbTG2d9Ipg",
                scenario);
        ...
        // define expected result
        AbstractUserAction startAction = TestItemProviderUtilities.getAbstractUserAction("__hs7kHD6EeSA4fySuX9I2Q",
                scenario);
        List<AbstractUserAction> expected = new ArrayList<AbstractUserAction>();
        expected.add(null);
